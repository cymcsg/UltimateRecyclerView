...
import com.ml93.captainmiaoUtil.ItemDecoration.ParallaxHeaderDecoration;
...
public class StaggerHeaderCol2Test extends BasicFunctions {
    ...
    protected void doURV(UltimateRecyclerView urv) {
        ...
        //ultimateRecyclerView.addItemDecoration(new ParallaxHeaderDecoration(this, R.drawable.jr6));
