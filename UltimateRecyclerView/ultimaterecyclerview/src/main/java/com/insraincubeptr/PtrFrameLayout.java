...
import com.insraincubeptr.util.PtrCLog;
 ...
 * It defines {@link com.insraincubeptr.PtrUIHandler}, which allows you customize the UI easily.
 */
public class PtrFrameLayout extends ViewGroup {
    ...
    protected final String LOG_TAG = "com.ptr-frame-" + ++ID;
    // auto refresh status
     ...
     *
     * @param ignoreHook is hooking working
     */
    ...
    /**
     * The content view will now move when set to true.
     *
     * @param pinContent na
     */
